...
{
    public class GTMainPage : BasePage
    {
        public GTMainPage(DriverProvider driverProvider, ConfigurationProvider configurationProvider) : base(driverProvider, configurationProvider)
        {
        }
        ...
        public string GetResult()
        {
            if (PlatformName.Equals(MobilePlatform.IOS))
            {
                return new Wait(Driver).WaitUntilElementContainsValue(Result, TimeSpan.FromSeconds(30));
            }

            return new Wait(Driver).WaitUntilElementContainsText(Result, TimeSpan.FromSeconds(30));
        }
        ...
        public void ClickOnCalculateButton()
        {
            ...
            new Wait(Driver).WaitUntilElementToBeDisplayed(CalculateButton, TimeSpan.FromSeconds(30));
